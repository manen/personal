		...
		<div className='m-4'>
            ...
            <div className='m-4 p-2 bg-bruh-50 text-white rounded-xl'>
              ...
              <p>I prefer to use Discord for communication.</p>
					...
					<a
						target='_blank'
						href='https://discord.com/users/856989682688458814'
					>
						<div className='m-4 p-2 bg-bruh-50 text-white rounded-xl'>
							<h2 className='text-xl'>Discord</h2>
							<p>simple, easy, quick</p>
						</div>
					</a>
					<a target='_blank' href='mailto:manen@manen.me'>
						<div className='m-4 p-2 bg-accent-100 hover:bg-accent-200 dark:bg-accent-800 dark:hover:bg-accent-700 transition-colors rounded-xl'>
							...
							<p>i don't know why you'd purposefully use e-mail, but sure</p>
						</div>
					</a>
				</div>
			</div>
