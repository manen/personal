...
const Contact: React.FC = () => (
  <div>
    ...
    <div className='m-4'>
      ...
      <div className='m-6'>
        <p>
          Unfortunately, my Discord account's been falsely disabled. Until I get
          that fixed, I'm going to mainly use Twitter DMs.
        </p>
        <div className='sm:grid sm:grid-cols-2 sm:divide-x sm:dark:divide-accent-900 sm:divide-white'>
          ...
          <a target='_blank' href='https://twitter.com/maneney_'>
            <div className='m-4 p-2 bg-bruh-200 text-white rounded-xl'>
              <h2 className='text-xl'>Twitter</h2>
              <p>I use Twitter until my Discord ban is lifted.</p>
            </div>
          </a>
